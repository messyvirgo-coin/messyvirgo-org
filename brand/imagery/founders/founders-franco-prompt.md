# Prompt for Founder Franco

Generate an anime-style illustration in 3:2 landscape format: Franco, keeping the same consistent face, hairstyle, and proportions as in the reference image. The character should appear clearly and recognizably in every variation.

Franco is positioned centrally in a very modern, slightly futuristic Crpypto Trader's command post at night, with many busy people around, large glass surfaces and distant city lights stretching into the background.
...
He's working on a laptop having an iced smoothie next to him.

Perspective: Half-figure to upper body (roughly knees-up to chest-up) so that the face is clearly visible. The image should be cleanly rendered, highly detailed, with a harmonious composition that keeps Franco in sharp focus against a dynamically chaotic but not distracting IT Department background.
