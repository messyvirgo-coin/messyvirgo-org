...
​
The overall scene is rather dark, with a poppy-punk mood and subtle neon colors in blue, pink, and violet, but not too bright. Add a **slightly warm** layer with **soft amber/yellow sunset highlights** that complement the pink/blue/violet accents (warm but not dominant). The background is partly photorealistic: wet asphalt reflecting neon lights, blurred yellow taxis, soft silhouettes of pedestrians, and big screens and signs creating a busy sunset/evening city atmosphere.
​
There are a few **abstract chart hints** (clean candlestick silhouettes, simple trend lines) but they must be **fully diegetic**: shown only on **real-world surfaces** like digital billboards, LED tickers, exchange screens, posters, reflected signage, or a **translucent panel projected from a visible device**. They should read as part of the city’s media environment, not as graphics added on top of the image.
